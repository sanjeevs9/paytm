export function Send(){
    return(
        <div className="flex flex-col  bg-white w-80  p-7 rounded-md">
            ...
            <div className="pb-3">
            <input placeholder="Enter amount" className="rounded-md bg-transparent w-full h-full outline outline-0 focus:outline-0 border border-black p-1"></input>
            </div>
            <div className="pb-3">
          <button  className=" bg-[#21c55d] text-white p-1 w-full rounded cursor-pointer">Initiate Transfer</button>
          </div>
