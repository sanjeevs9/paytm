export function Signup(){
    return(
      ...
      <div class="flex flex-col p-5 items-center ">
        ...
        <input className="rounded-md bg-transparent w-full h-full outline outline-0 focus:outline-0 border border-black p-1"></input>
        ...
        <div className="pb-3 text-black font-medium">Email</div>
         ...
         <div className="pb-3 "><input className="rounded-md bg-transparent w-full h-full outline outline-0 focus:outline-0 border border-black p-1" ></input></div>
          <div className="pb-3">
          <button className=" bg-[#18181b] text-white p-1 w-full rounded ">Sign up</button>
          </div>
